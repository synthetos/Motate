...
$(2)_ASM_OBJECTS_$(1) := $(addprefix $$(OUTDIR)/,$($(2)_ASM_OBJECTS))

ALL_C_OBJECTS_$(1)   += $$($(2)_C_OBJECTS_$(1))
ALL_CXX_OBJECTS_$(1) += $$($(2)_CXX_OBJECTS_$(1))
ALL_ASM_OBJECTS_$(1) += $$($(2)_ASM_OBJECTS_$(1))

DEVICE_OBJECTS_$(1) = $$(OUTDIR)/$(3).a

$$(OUTDIR)/$(3).a: $$(OUTDIR)/$(3).a($$($(2)_C_OBJECTS_$(1)) $$($(2)_CXX_OBJECTS_$(1)) $$($(2)_ASM_OBJECTS_$(1)))
endef
