...
namespace Motate {
    ...
    _MAKE_MOTATE_PWM_PIN('A',  8, Motate::PWMTimer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN( 1, A, 'A',  9);	// D1, TX0
    _MAKE_MOTATE_PWM_PIN('A',  9, Motate::PWMTimer<3>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN( 2, B, 'B', 25);	// D2, PWM2
    _MAKE_MOTATE_PWM_PIN('B', 25, Motate::Timer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 3, C, 'C', 28);	// D3, PWM3
    _MAKE_MOTATE_PWM_PIN('C', 28, Motate::Timer<7>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 4, C, 'C', 26);	// D4, PWM4
    _MAKE_MOTATE_PWM_PIN('C', 26, Motate::Timer<6>, /*Channel:*/ 1, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 5, C, 'C', 25);	// D5, PWM5
    _MAKE_MOTATE_PWM_PIN('C', 25, Motate::Timer<6>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 6, C, 'C', 24);	// D6, PWM6
    _MAKE_MOTATE_PWM_PIN('C', 24, Motate::PWMTimer<7>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 7, C, 'C', 23);	// D7, PWM7
    _MAKE_MOTATE_PWM_PIN('C', 23, Motate::PWMTimer<6>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 8, C, 'C', 22);	// D8, PWM8
    _MAKE_MOTATE_PWM_PIN('C', 22, Motate::PWMTimer<5>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN( 9, C, 'C', 21);	// D9, PWM9
    _MAKE_MOTATE_PWM_PIN('C', 21, Motate::PWMTimer<4>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(10, C, 'C', 29);	// D10, PWM10
    _MAKE_MOTATE_PWM_PIN('C', 29, Motate::Timer<7>, /*Channel:*/ 1, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(11, D, 'D',  7);	// D11, PWM11
    _MAKE_MOTATE_PWM_PIN('D',  7, Motate::Timer<8>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(12, D, 'D',  8);	// D12, PWM12
    _MAKE_MOTATE_PWM_PIN('D',  8, Motate::Timer<8>, /*Channel:*/ 1, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(13, B, 'B', 27);	// D13, PWM13, LED Indicator
    _MAKE_MOTATE_PWM_PIN('B', 27, Motate::Timer<0>, /*Channel:*/ 1, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(14, D, 'D',  4);	// D14, TX3
    _MAKE_MOTATE_PIN(15, D, 'D',  5);	// D15, RX3
    _MAKE_MOTATE_PIN(16, A, 'A', 13);	// D16, TX2
    _MAKE_MOTATE_PWM_PIN('A', 13, Motate::PWMTimer<2>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(17, A, 'A', 12);	// D17, RX2
    _MAKE_MOTATE_PWM_PIN('A', 12, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(18, A, 'A', 11);	// D18, TX1
    _MAKE_MOTATE_PIN(19, A, 'A', 10);	// D19, RX1
    _MAKE_MOTATE_PIN(20, B, 'B', 12);	// D20, SDA
    _MAKE_MOTATE_PWM_PIN('B', 12, Motate::PWMTimer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(21, B, 'B', 13);	// D21, SCL
    _MAKE_MOTATE_PWM_PIN('B', 13, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!
    ...
    _MAKE_MOTATE_PWM_PIN('C',  2, Motate::PWMTimer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(35, C, 'C',  3);	// D35
    _MAKE_MOTATE_PWM_PIN('C',  3, Motate::PWMTimer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(36, C, 'C',  4);	// D36
    _MAKE_MOTATE_PWM_PIN('C',  4, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(37, C, 'C',  5);	// D37
    _MAKE_MOTATE_PWM_PIN('C',  5, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(38, C, 'C',  6);	// D38
    _MAKE_MOTATE_PWM_PIN('C',  6, Motate::PWMTimer<2>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(39, C, 'C',  7);	// D39
    _MAKE_MOTATE_PWM_PIN('C',  7, Motate::PWMTimer<2>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(40, C, 'C',  8);	// D40
    _MAKE_MOTATE_PWM_PIN('C',  8, Motate::PWMTimer<3>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(41, C, 'C',  9);	// D41
    _MAKE_MOTATE_PWM_PIN('C',  9, Motate::PWMTimer<3>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(42, A, 'A', 19);	// D42
    _MAKE_MOTATE_PWM_PIN('A', 19, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(43, A, 'A', 20);	// D43
    _MAKE_MOTATE_PWM_PIN('A', 20, Motate::PWMTimer<2>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(44, C, 'C', 19);	// D44
    _MAKE_MOTATE_PWM_PIN('C', 19, Motate::PWMTimer<5>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!

    _MAKE_MOTATE_PIN(45, C, 'C', 18);	// D45
    _MAKE_MOTATE_PWM_PIN('C', 18, Motate::PWMTimer<6>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ true); // INVERTED!
    ...
    _MAKE_MOTATE_PWM_PIN('A',  6, Motate::Timer<2>, /*Channel:*/ 1, /*Peripheral:*/ A, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(59, A, 'A',  4);	// A5
    _MAKE_MOTATE_PIN(60, A, 'A',  3);	// A6
    _MAKE_MOTATE_PWM_PIN('A',  3, Motate::Timer<1>, /*Channel:*/ 1, /*Peripheral:*/ A, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(61, A, 'A',  2);	// A7
    _MAKE_MOTATE_PWM_PIN('A',  2, Motate::Timer<1>, /*Channel:*/ 0, /*Peripheral:*/ A, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(62, B, 'B', 17);	// A8
    _MAKE_MOTATE_PWM_PIN('B', 17, Motate::PWMTimer<1>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(63, B, 'B', 18);	// A9
    _MAKE_MOTATE_PWM_PIN('B', 18, Motate::PWMTimer<2>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);
    ...
    _MAKE_MOTATE_PWM_PIN('B', 16, Motate::PWMTimer<0>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);

    _MAKE_MOTATE_PIN(68, A, 'A',  1);	// CANRX
    _MAKE_MOTATE_PIN(69, A, 'A',  0);	// CANTX
    _MAKE_MOTATE_PWM_PIN('A',  0, Motate::PWMTimer<3>, /*Channel:*/ 0, /*Peripheral:*/ B, /*Inverted:*/ false);
